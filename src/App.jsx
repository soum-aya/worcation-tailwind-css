            ...
            <div className="bg-gray-100 grid lg:grid-cols-2 2xl:grid-cols-5">
                <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 2xl:col-span-2">
                    <div className="xl:max-w-xl">
                        ...
                        <img className="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:w-full sm:object-cover object-center lg:hidden" src="/img/free-work.jpg" alt="Woman workcationing on the mountain" />
                        <h1 className="mt-8 text-2xl font-headline tracking-tight font-semibold text-gray-900 sm:mt-8 sm:text-4xl lg:text-3xl xl:text-4xl">
                ...
                <div className="hidden relative lg:block 2xl:col-span-3">
                    <img className="absolue inset-0 w-full h-full object-cover object-center" src="/img/free-work.jpg" alt="Woman workcationing on the mountain" />
                </div>
            </div>

            <div className="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
                <h2 className="text-xl text-gray-900">Popular destinations</h2>
                <p className="text-xl text-gray-600">A selection of great work-friendly cities with lots to see and explore.</p>
